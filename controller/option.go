...
func UpdateOption(c *gin.Context) {
	...
	case creationModelCategoriesOptionKey:
		err = validateCreationModelCategories(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
	...
	case creationModelOrderOptionKey:
		err = validateCreationModelOrder(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),

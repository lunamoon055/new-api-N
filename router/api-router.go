...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.DecompressRequestMiddleware())
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/image-results/:filename", middleware.UserAuth(), controller.GetImageGenerationResult)
		...
		apiRouter.POST("/creation/images/async-generations", middleware.UserAuth(), middleware.CreationImageAsyncRequestConvert(), middleware.Distribute(), controller.CreationRelayImageTask)
		...
		apiRouter.POST("/oauth/email/bind", middleware.CriticalRateLimit(), middleware.TryUserAuth(), controller.EmailBind)
		// Non-standard OAuth (WeChat, Telegram) - keep original routes
		apiRouter.GET("/oauth/wechat", middleware.CriticalRateLimit(), controller.WeChatAuth)
		apiRouter.POST("/oauth/wechat/bind", middleware.CriticalRateLimit(), middleware.TryUserAuth(), controller.WeChatBind)
		apiRouter.GET("/oauth/telegram/login", middleware.CriticalRateLimit(), controller.TelegramLogin)
		apiRouter.GET("/oauth/telegram/bind", middleware.CriticalRateLimit(), middleware.TryUserAuth(), controller.TelegramBind)
		// Standard OAuth providers (GitHub, Discord, OIDC, LinuxDO) - unified route
		apiRouter.GET("/oauth/:provider", middleware.CriticalRateLimit(), middleware.TryUserAuth(), controller.HandleOAuth)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/test_lab/:id", controller.TestChannelLab)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.PUT("/description", controller.UpdateModelDescription)
